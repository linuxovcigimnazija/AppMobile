  ...
  return (
    <View style={styles.wholescreen}>
      ...
      <View style={styles.tabContainer}>
        ...
        <TouchableOpacity style={styles.singleTab}  onPress={() => {setTab('month')}}> 
        ...
        <TouchableOpacity style={styles.singleTab}  onPress={() => {setTab('year')}}> 
          <LinearGradient colors={[Constants.boxcolorLight, Constants.boxcolorDark]}
          style={styles.smallboxGradient}>
        ...
        <TouchableOpacity style={styles.singleTab}  onPress={() => {setTab('all')}}> 
          <LinearGradient colors={[Constants.boxcolorLight, Constants.boxcolorDark]}
          style={styles.smallboxGradient}>
      ...
      <Tab style={styles.tabStyle} page={tab}>
      </Tab>
    </View>
  );
};
