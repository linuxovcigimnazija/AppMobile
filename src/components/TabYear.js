...
const TabYear = (props) => {
  ...
  if (props.data.data.fuel.length != 0) {
    for (var item in props.data.data.fuel) {
      if (props.data.data.fuel[item].date > (Date.now() - 31622400000000) ) {
