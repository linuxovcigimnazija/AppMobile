      ...
      switch (action.type) {
        ...
        case 'PUSH':
          if (state.routeNames.includes(action.payload.name)) {
            ...
            const route = action.payload.name && action.payload.key ? state.routes.find(route => route.name === action.payload.name && route.key === action.payload.key) : id ? state.routes.find(route => id === (getId === null || getId === void 0 ? void 0 : getId({
              params: route.params
            }))) : undefined;
            let routes;
        ...
        case 'NAVIGATE':
          if (action.payload.key || action.payload.name && state.routeNames.includes(action.payload.name)) {
            ...
            if (id) {
              index = state.routes.findIndex(route => id === (getId === null || getId === void 0 ? void 0 : getId({
                params: route.params
              })));
