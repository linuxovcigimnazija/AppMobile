...
var LoadBundleTask = /** @class */ (function () {
    function LoadBundleTask() {
        ...
        this._taskCompletionResolver = new database25e1c0cb.Deferred();
        this._lastProgress = {
            taskState: 'Running',
            totalBytes: 0,
            totalDocuments: 0,
...
function loadBundle(db, bundleData) {
    ...
    database25e1c0cb.firestoreClientLoadBundle(database25e1c0cb.ensureFirestoreConfigured(db._delegate), db._databaseId, bundleData, resultTask);
    return resultTask;
}
function namedQuery(db, name) {
    return database25e1c0cb.firestoreClientGetNamedQuery(database25e1c0cb.ensureFirestoreConfigured(db._delegate), name).then(function (namedQuery) {
        if (!namedQuery) {
            return null;
        }
        return new database25e1c0cb.Query$1(db, new database25e1c0cb.Query(db._delegate, null, namedQuery.query));
    });
}
/**
 * @license
...
registerBundle(database25e1c0cb.Firestore);
